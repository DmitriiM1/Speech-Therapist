        ...
        <div className="price_container">
            ...
            <div className="price_container_wrapper">
                ...
                <div className="price_list">
                    <ul className="individual">
                        <li><span className="span_colour_price">Цена: </span>1700р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>1200р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>1000р <span className="span_colour_time">Время: </span><span>20 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>2000р <span className="span_colour_time">Время: </span><span>30 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>2000р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>2000р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>2000р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>2000р <span className="span_colour_time">Время: </span><span>40 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>1700р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>1700р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                        <li><span className="span_colour_price">Цена: </span>1700р <span className="span_colour_time">Время: </span><span>45 минут</span></li>
                    </ul>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><p>Обучение чтению по авторской методике с частичным использованием кубиков Зайцева </p></td>
                            <td>
                                <span className="span_colour_price">Цена: </span>9600р
                            </td>
                        </tr>
                        <tr>
